...
panel_plot_A_and_gsw_vs_tleaf_both_HWS <- plot_grid (A_vs_leafT_licor_first_HW_r_3_4,A_vs_leafT_licor_second_HW_r_3_4,gsw_vs_leafT_licor_first_HW_r_3_4,gsw_vs_leafT_licor_second_HW_r_3_4, ncol=2, nrow = 2)
...
diurnals_2019_gsw_vs_leafT_licor_second_HW_r_3_4_trial<-diurnals_2019_gsw_vs_leafT_licor_second_HW_r_3_4%>%
  filter(treatment == 1)

diurnals_2019_gsw_vs_leafT_licor_second_HW_r_3_4_trial%>%
  tally()

physio_respone_fit <- lm(gsw ~ poly(Tleaf, 2), data = diurnals_2019_gsw_vs_leafT_licor_second_HW_r_3_4_trial)
...
physio_respone_fit <- predict(physio_respone_fit,diurnals_2019_gsw_vs_leafT_licor_second_HW_r_3_4_trial, interval = "confidence")

summary(physio_respone_fit)


diurnals_2019_gsw_vs_leafT_licor_second_HW_r_3_4_trial <- diurnals_2019_gsw_vs_leafT_licor_second_HW_r_3_4_triall %>% 
