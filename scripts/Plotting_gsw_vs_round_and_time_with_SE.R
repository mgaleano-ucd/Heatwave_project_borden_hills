...
diurnals_2019_gsw_vs_round_jul_25<- diurnals_2019_gsw_vs_round %>%
  filter(!is.na(gsw)) %>%
  select(datetime, day, gsw, pixel_number, round, treatment, Rep, BH_Leaf, BH_Block) %>%
  filter(day == "206")

write.csv(diurnals_2019_gsw_vs_round_jul_25,"data_output/diurnals_2019_gsw_vs_round_jul_25")

diurnals_2019_gsw_vs_round_jul_25_avg_se <-diurnals_2019_gsw_vs_round_jul_25 %>%
  group_by(treatment, round) %>%
  summarise(avg_gsw = mean(gsw), sev = se(gsw))

write.csv(diurnals_2019_gsw_vs_round_jul_25_avg_se, "data_output/diurnals_2019_gsw_vs_round_jul_25_avg_se")

diurnals_2019_gsw_vs_round_jul_25_avg_se$treatment<- reorder(diurnals_2019_gsw_vs_round_jul_25_avg_se$treatment, diurnals_2019_gsw_vs_round_jul_25_avg_se$round)

diurnals_2019_gsw_vs_round_jul_25$treatment<- reorder(diurnals_2019_gsw_vs_round_jul_25$treatment, diurnals_2019_gsw_vs_round_jul_25$round)



diurnals_2019_gsw_vs_round_jul_25$Rep<-format(diurnals_2019_gsw_vs_round_jul_25$Rep)
as.character(diurnals_2019_gsw_vs_round_jul_25$Rep)
...
gswjul25_round_avg_se<-ggplot(diurnals_2019_gsw_vs_round_jul_25_avg_se, aes(round, avg_gsw, group = treatment, color = treatment)) + 
  geom_errorbar(aes(ymin=avg_gsw-sev, ymax=avg_gsw+sev), width=.2, position=pd, stat = "identity") +
  ...
  ylab(label = "Stomatal conductance (gsw)") +
  ggtitle( " gsw vs round diurnal Jul 25 2019") +
  ...
  scale_y_continuous(breaks=seq(-0.2,1.0,0.2), limits = c (-0.2,0.8))


ggsave(gswjul25_round_avg_se, filename = "figures/gswjul25_round_avg_se.pdf", device = cairo_pdf, 
       width = 8, height = 6)


####Plotting Avs round diurnals Jul 28 (during first heatwave) ####

diurnals_2019_gsw_vs_round_jul_28<- diurnals_2019_gsw_vs_round %>%
  filter(!is.na(gsw)) %>%
  select(datetime, day, gsw, pixel_number, round, treatment, Rep, BH_Leaf, BH_Block) %>%
  filter(day == "209")

diurnals_2019_gsw_vs_round_jul_28_avg_se <-diurnals_2019_gsw_vs_round_jul_28 %>%
  group_by(treatment, round) %>%
  summarise(avg_gsw = mean(gsw), sev = se(gsw))


diurnals_2019_gsw_vs_round_jul_28_avg_se$treatment<- reorder(diurnals_2019_gsw_vs_round_jul_28_avg_se$treatment, diurnals_2019_gsw_vs_round_jul_28_avg_se$round)

diurnals_2019_gsw_vs_round_jul_28$treatment<- reorder(diurnals_2019_gsw_vs_round_jul_28$treatment, diurnals_2019_gsw_vs_round_jul_28$round)


diurnals_2019_gsw_vs_round_jul_28$Rep<-format(diurnals_2019_gsw_vs_round_jul_28$Rep)
as.character(diurnals_2019_gsw_vs_round_jul_28$Rep)
...
gswjul28_round_avg_se<-ggplot(diurnals_2019_gsw_vs_round_jul_28_avg_se, aes(round, avg_gsw, group = treatment, color = treatment)) + 
  geom_errorbar(aes(ymin=avg_gsw-sev, ymax=avg_gsw+sev), width=.2, position=pd, stat = "identity") +
  geom_line(alpha =0.5, size =1, position=pd, stat = "identity", linetype = "solid") +
  geom_point(alpha =0.3, position=pd, size=2, stat = "identity") + 
  theme_classic()+
  scale_color_manual(values = c("springgreen4", "darkorange1", "dodgerblue2"), name = "Treatment", labels = c("Baseline (60% ET)", "2x baseline ET", "3x baseline ET")) +
  ylab(label = "Stomatal conductance (gsw)") +
  ggtitle( " gsw vs round diurnal Jul 28 2019") +
  theme(plot.title = element_text(hjust = 0.5, size = 18, face = "bold", family = "serif")) +
  xlab("Round") +
  theme(axis.title.y = element_text(size=16, face = "bold", family = "serif")) +
  theme(axis.title.x = element_text(size=14, family = "serif")) +
...
ggsave(gswjul28_round_avg_se, filename = "figures/gswjul28_round_avg_se.pdf", device = cairo_pdf, 
       width = 8, height = 6)


#### Plotting gswvs round  diurnals Aug 1 (after first heatwave) ####

diurnals_2019_gsw_vs_round_aug_1<- diurnals_2019_gsw_vs_round %>%
  filter(!is.na(gsw)) %>%
  select(datetime, day, gsw, pixel_number, round, treatment, Rep, BH_Leaf, BH_Block) %>%
  filter(day == "213") %>%
  filter(gsw < 2)
...
diurnals_2019_gsw_vs_round_aug_1<- diurnals_2019_gsw_vs_round_aug_1 [-15, ]
diurnals_2019_gsw_vs_round_aug_1<- diurnals_2019_gsw_vs_round_aug_1 [-13, ]
diurnals_2019_gsw_vs_round_aug_1_avg_se <-diurnals_2019_gsw_vs_round_aug_1 %>%
  group_by(treatment, round) %>%
  summarise(avg_gsw = mean(gsw), sev = se(gsw))


diurnals_2019_gsw_vs_round_aug_1_avg_se$treatment<- reorder(diurnals_2019_gsw_vs_round_aug_1_avg_se$treatment, diurnals_2019_gsw_vs_round_aug_1_avg_se$round)

diurnals_2019_gsw_vs_round_aug_1$treatment<- reorder(diurnals_2019_gsw_vs_round_aug_1$treatment, diurnals_2019_gsw_vs_round_aug_1$round)


diurnals_2019_gsw_vs_round_aug_1$Rep<-format(diurnals_2019_gsw_vs_round_aug_1$Rep)
as.character(diurnals_2019_gsw_vs_round_aug_1$Rep)


#Plot Aug 1

gswaug1_round_avg_se<-ggplot(diurnals_2019_gsw_vs_round_aug_1_avg_se, aes(round, avg_gsw, group = treatment, color = treatment)) + 
  geom_errorbar(aes(ymin=avg_gsw-sev, ymax=avg_gsw+sev), width=.2, position=pd, stat = "identity") +
  geom_line(alpha =0.5, size =1, position=pd, stat = "identity", linetype = "solid") +
  geom_point(alpha =0.3, position=pd, size=2, stat = "identity") + 
  theme_classic()+
  scale_color_manual(values = c("springgreen4", "darkorange1", "dodgerblue2"), name = "Treatment", labels = c("Baseline (60% ET)", "2x baseline ET", "3x baseline ET")) +
  ylab(label = "Stomatal conductance (gsw)") +
  ggtitle( " gsw vs round diurnal Aug 1 2019") +
  theme(plot.title = element_text(hjust = 0.5, size = 18, face = "bold", family = "serif")) +
  xlab("Round") +
  theme(axis.title.y = element_text(size=16, face = "bold", family = "serif")) +
  theme(axis.title.x = element_text(size=14, family = "serif")) +
...
ggsave(gswaug1_round_avg_se, filename = "figures/gswaug1_round_avg_se.pdf", device = cairo_pdf, 
       width = 8, height = 6)


#### Plotting A vs round diurnals Aug 15 (before second heatwave) ####

diurnals_2019_gsw_vs_round_aug_15<- diurnals_2019_gsw_vs_round %>%
  filter(!is.na(gsw)) %>%
  select(datetime, day, gsw, pixel_number, round, treatment, Rep, BH_Leaf, BH_Block) %>%
  filter(day == "227")

diurnals_2019_gsw_vs_round_aug_15_avg_se <-diurnals_2019_gsw_vs_round_aug_15 %>%
  group_by(treatment, round) %>%
  summarise(avg_gsw = mean(gsw), sev = se(gsw))


diurnals_2019_gsw_vs_round_aug_15_avg_se$treatment<- reorder(diurnals_2019_gsw_vs_round_aug_15_avg_se$treatment, diurnals_2019_gsw_vs_round_aug_15_avg_se$round)

diurnals_2019_gsw_vs_round_aug_15$treatment<- reorder(diurnals_2019_gsw_vs_round_aug_15$treatment, diurnals_2019_gsw_vs_round_aug_15$round)


diurnals_2019_gsw_vs_round_aug_15$Rep<-format(diurnals_2019_gsw_vs_round_aug_15$Rep)
as.character(diurnals_2019_gsw_vs_round_aug_15$Rep)


#Plot Aug 15

gswaug15_round_avg_se<-ggplot(diurnals_2019_gsw_vs_round_aug_15_avg_se, aes(round, avg_gsw, group = treatment, color = treatment)) + 
  geom_errorbar(aes(ymin=avg_gsw-sev, ymax=avg_gsw+sev), width=.2, position=pd, stat = "identity") +
  geom_line(alpha =0.5, size =1, position=pd, stat = "identity", linetype = "solid") +
  geom_point(alpha =0.3, position=pd, size=2, stat = "identity") + 
  theme_classic()+
  scale_color_manual(values = c("springgreen4", "darkorange1", "dodgerblue2"), name = "Treatment", labels = c("Baseline (60% ET)", "2x baseline ET", "3x baseline ET")) +
  ylab(label = "Stomatal conductance (gsw)") +
  ggtitle( " gsw vs round diurnal Aug 15 2019") +
  theme(plot.title = element_text(hjust = 0.5, size = 18, face = "bold", family = "serif")) +
  xlab("Round") +
  theme(axis.title.y = element_text(size=16, face = "bold", family = "serif")) +
  theme(axis.title.x = element_text(size=14, family = "serif")) +
...
ggsave(gswaug15_round_avg_se, filename = "figures/gswaug15_round_avg_se.pdf", device = cairo_pdf, 
       width = 8, height = 6)
...
diurnals_2019_gsw_vs_round_aug_20<- diurnals_2019_gsw_vs_round %>%
  filter(!is.na(gsw)) %>%
  select(datetime, day, gsw, pixel_number, round, treatment, Rep, BH_Leaf, BH_Block) %>%
  filter(day == "232") %>%
  filter(gsw <0.9)
...
diurnals_2019_gsw_vs_round_aug_20_avg_se <-diurnals_2019_gsw_vs_round_aug_20 %>%
  group_by(treatment, round) %>%
  summarise(avg_gsw = mean(gsw), sev = se(gsw))


diurnals_2019_gsw_vs_round_aug_20_avg_se$treatment<- reorder(diurnals_2019_gsw_vs_round_aug_20_avg_se$treatment, diurnals_2019_gsw_vs_round_aug_20_avg_se$round)

diurnals_2019_gsw_vs_round_aug_20$treatment<- reorder(diurnals_2019_gsw_vs_round_aug_20$treatment, diurnals_2019_gsw_vs_round_aug_20$round)


diurnals_2019_gsw_vs_round_aug_20$Rep<-format(diurnals_2019_gsw_vs_round_aug_20$Rep)
as.character(diurnals_2019_gsw_vs_round_aug_20$Rep)


#Plot Aug 20

gswaug20_round_avg_se<-ggplot(diurnals_2019_gsw_vs_round_aug_20_avg_se, aes(round, avg_gsw, group = treatment, color = treatment)) + 
  geom_errorbar(aes(ymin=avg_gsw-sev, ymax=avg_gsw+sev), width=.2, position=pd, stat = "identity") +
  geom_line(alpha =0.5, size =1, position=pd, stat = "identity", linetype = "solid") +
  geom_point(alpha =0.3, position=pd, size=2, stat = "identity") + 
  theme_classic()+
  scale_color_manual(values = c("springgreen4", "darkorange1", "dodgerblue2"), name = "Treatment", labels = c("Baseline (60% ET)", "2x baseline ET", "3x baseline ET")) +
  ylab(label = "Stomatal conductance (gsw)") +
  ggtitle(" gsw vs round diurnal Aug 20 2019") +
  theme(plot.title = element_text(hjust = 0.5, size = 18, face = "bold", family = "serif")) +
  xlab("Round") +
  theme(axis.title.y = element_text(size=16, face = "bold", family = "serif")) +
  theme(axis.title.x = element_text(size=14, family = "serif")) +
...
ggsave(gswaug20_round_avg_se, filename = "figures/gswaug20_round_avg_se.pdf", device = cairo_pdf, 
       width = 8, height = 6)

######## Plotting A vs round  diurnals sep 5 (after second heatwave) ####


diurnals_2019_gsw_vs_round_sep_5<- diurnals_2019_gsw_vs_round %>%
  filter(!is.na(gsw)) %>%
  select(datetime, day, gsw, pixel_number, round, treatment, Rep, BH_Leaf, BH_Block) %>%
  filter(day == "248")

diurnals_2019_gsw_vs_round_sep_5_avg_se <-diurnals_2019_gsw_vs_round_sep_5 %>%
  group_by(treatment, round) %>%
  summarise(avg_gsw = mean(gsw), sev = se(gsw))


diurnals_2019_gsw_vs_round_sep_5_avg_se$treatment<- reorder(diurnals_2019_gsw_vs_round_sep_5_avg_se$treatment, diurnals_2019_gsw_vs_round_sep_5_avg_se$round)

diurnals_2019_gsw_vs_round_sep_5$treatment<- reorder(diurnals_2019_gsw_vs_round_sep_5$treatment, diurnals_2019_gsw_vs_round_sep_5$round)


diurnals_2019_gsw_vs_round_sep_5$Rep<-format(diurnals_2019_gsw_vs_round_sep_5$Rep)
as.character(diurnals_2019_gsw_vs_round_sep_5$Rep)


#Plot Sep 5

gswsep5_round_avg_se<-ggplot(diurnals_2019_gsw_vs_round_sep_5_avg_se, aes(round, avg_gsw, group = treatment, color = treatment)) + 
  geom_errorbar(aes(ymin=avg_gsw-sev, ymax=avg_gsw+sev), width=.2, position=pd, stat = "identity") +
  geom_line(alpha =0.5, size =1, position=pd, stat = "identity", linetype = "solid") +
  geom_point(alpha =0.3, position=pd, size=2, stat = "identity") + 
  theme_classic()+
  scale_color_manual(values = c("springgreen4", "darkorange1", "dodgerblue2"), name = "Treatment", labels = c("Baseline (60% ET)", "2x baseline ET", "3x baseline ET")) +
  ylab(label = "Stomatal conductance (gsw)") +
  ggtitle( " gsw vs round diurnal Sep 5 2019") +
  theme(plot.title = element_text(hjust = 0.5, size = 18, face = "bold", family = "serif")) +
  xlab("Round") +
  theme(axis.title.y = element_text(size=16, face = "bold", family = "serif")) +
  theme(axis.title.x = element_text(size=14, family = "serif")) +
...
ggsave(gswsep5_round_avg_se, filename = "figures/gswsep5_round_avg_se.pdf", device = cairo_pdf, 
       width = 8, height = 6)

####Plotting A vs round for first diurnals before block ID change - Baseline ####
diurnals_2019_gsw_vs_round_jul_12<- diurnals_2019_gsw_vs_round %>%
  filter(!is.na(gsw)) %>%
  select(datetime, day, gsw, pixel_number, round, treatment, Rep, BH_Leaf, BH_Block) %>%
  filter(day == "193") %>%
  filter(gsw < 1.0)

diurnals_2019_gsw_vs_round_jul_12_avg_se <-diurnals_2019_gsw_vs_round_jul_12 %>%
  group_by(treatment, round) %>%
  summarise(avg_gsw = mean(gsw), sev = se(gsw))


diurnals_2019_gsw_vs_round_jul_12_avg_se$treatment<- reorder(diurnals_2019_gsw_vs_round_jul_12_avg_se$treatment, diurnals_2019_gsw_vs_round_jul_12_avg_se$round)

diurnals_2019_gsw_vs_round_jul_12$treatment<- reorder(diurnals_2019_gsw_vs_round_jul_12$treatment, diurnals_2019_gsw_vs_round_jul_12$round)


diurnals_2019_gsw_vs_round_jul_12$Rep<-format(diurnals_2019_gsw_vs_round_jul_12$Rep)
as.character(diurnals_2019_gsw_vs_round_jul_12$Rep)


#Plot Jul 12

gswjul12_round_avg_se<-ggplot(diurnals_2019_gsw_vs_round_jul_12_avg_se, aes(round, avg_gsw, group = treatment, color = treatment)) + 
  geom_errorbar(aes(ymin=avg_gsw-sev, ymax=avg_gsw+sev), width=.2, position=pd, stat = "identity") +
  geom_line(alpha =0.5, size =1, position=pd, stat = "identity", linetype = "solid") +
  geom_point(alpha =0.3, position=pd, size=2, stat = "identity") + 
  theme_classic()+
  scale_color_manual(values = c("springgreen4", "darkorange1", "dodgerblue2"), name = "Treatment", labels = c("Baseline (60% ET)", "2x baseline ET", "3x baseline ET")) +
  ylab(label = "Stomatal conductance (gsw)") +
  ggtitle( " gsw vs round diurnal Jul 12 2019") +
  theme(plot.title = element_text(hjust = 0.5, size = 18, face = "bold", family = "serif")) +
  xlab("Round") +
  theme(axis.title.y = element_text(size=16, face = "bold", family = "serif")) +
  theme(axis.title.x = element_text(size=14, family = "serif")) +
...
ggsave(gswjul12_round_avg_se, filename = "figures/gswjul12_round_avg_se.pdf", device = cairo_pdf, 
       width = 8, height = 6)

#### Plotting A vs round Jul 1

diurnals_2019_gsw_vs_round_jul_1<- diurnals_2019_gsw_vs_round %>%
  filter(!is.na(gsw)) %>%
  select(datetime, day, gsw, pixel_number, round, treatment, Rep, BH_Leaf, BH_Block) %>%
  filter(day == "182") %>%
  filter(gsw < 1.0)

diurnals_2019_gsw_vs_round_jul_1_avg_se <-diurnals_2019_gsw_vs_round_jul_1 %>%
  group_by(treatment, round) %>%
  summarise(avg_gsw = mean(gsw), sev = se(gsw))


diurnals_2019_gsw_vs_round_jul_1_avg_se$treatment<- reorder(diurnals_2019_gsw_vs_round_jul_1_avg_se$treatment, diurnals_2019_gsw_vs_round_jul_1_avg_se$round)

diurnals_2019_gsw_vs_round_jul_1$treatment<- reorder(diurnals_2019_gsw_vs_round_jul_1$treatment, diurnals_2019_gsw_vs_round_jul_1$round)


diurnals_2019_gsw_vs_round_jul_1$Rep<-format(diurnals_2019_gsw_vs_round_jul_1$Rep)
as.character(diurnals_2019_gsw_vs_round_jul_1$Rep)


#Plot Jul 1

gswjul1_round_avg_se<-ggplot(diurnals_2019_gsw_vs_round_jul_1_avg_se, aes(round, avg_gsw, group = treatment, color = treatment)) + 
  geom_errorbar(aes(ymin=avg_gsw-sev, ymax=avg_gsw+sev), width=.2, position=pd, stat = "identity") +
  geom_line(alpha =0.5, size =1, position=pd, stat = "identity", linetype = "solid") +
  geom_point(alpha =0.3, position=pd, size=2, stat = "identity") + 
  theme_classic()+
  scale_color_manual(values = c("springgreen4", "darkorange1", "dodgerblue2"), name = "Treatment", labels = c("Baseline (60% ET)", "2x baseline ET", "3x baseline ET")) +
  ylab(label = "Stomatal conductance (gsw)") +
  ggtitle( " gsw vs round diurnal Jul 1 2019") +
  theme(plot.title = element_text(hjust = 0.5, size = 18, face = "bold", family = "serif")) +
  xlab("Round") +
  theme(axis.title.y = element_text(size=16, face = "bold", family = "serif")) +
  theme(axis.title.x = element_text(size=14, family = "serif")) +
...
ggsave(gswjul1_round_avg_se, filename = "figures/gswjul1_round_avg_se.pdf", device = cairo_pdf, 
       width = 8, height = 6)
...
panel_plot_gsw_round_2019_avg_se<- plot_grid (gswjul25_round_avg_se, gswjul28_round_avg_se, gswaug1_round_avg_se, gswaug15_round_avg_se, gswaug20_round_avg_se, gswsep5_round_avg_se, labels=c("Pre-heatwave", "Heatwave", "Post-heatwave","Heatwave", "Post-heatwave", "Post-heatwave", ncol=3, nrow = 2), vjust = 5.8, hjust = -1.5, label_size = 10)

ggsave(panel_plot_gsw_round_2019_avg_se  , filename = "figures/panel_plot_gsw_round_2019_avg_se.pdf", device = cairo_pdf, width = 14, height = 8)


# Everyhting all diurnals and blocks

panel_plot_gsw_round_2019_avg_se_w_baseline<- plot_grid (gswjul1_round_avg_se,gswjul12_round_avg_se, gswjul25_round_avg_se, gswjul28_round_avg_se, gswaug1_round_avg_se, gswaug15_round_avg_se, gswaug20_round_avg_se, gswsep5_round_avg_se, labels=c("Baseline","Baseline","Pre-heatwave", "Heatwave", "Post-heatwave","Heatwave", "Post-heatwave", "Post-heatwave", ncol=3, nrow = 3), vjust = 4.2, hjust = -1.5, label_size = 10)

ggsave(panel_plot_gsw_round_2019_avg_se_w_baseline , filename = "figures/panel_plot_gsw_round_2019_avg_se_w_baseline.pdf", device = cairo_pdf, width = 14, height = 12)

####stomatal conductance vs time not rounds jul 25 and no data points(impossible to plot everything together, time series too long) #### 
...
gswjul25_time_avg_se<-ggplot(diurnals_2019_gsw_vs_time_Jul25_avg_se, aes(interval, avg_gsw, group = treatment, color = treatment)) + 
  ...
  annotate("text", x = as.POSIXct("07-25-2019 08:45:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) +
  annotate("text", x = as.POSIXct("07-25-2019 11:10:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) +
  annotate("text", x = as.POSIXct("07-25-2019 13:10:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6)  +
  annotate("text", x = as.POSIXct("07-25-2019 17:10:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) 


ggsave(gswjul25_time_avg_se, filename = "figures/gswjul25_time_avg_se.pdf", device = cairo_pdf, width = 8, height = 6)
...
gswjul28_time_avg_se<-ggplot(diurnals_2019_gsw_vs_time_Jul28_avg_se, aes(interval, avg_gsw, group = treatment, color = treatment)) + 
  ...
  scale_y_continuous(breaks=seq(0,0.6,0.1), limits = c (0,0.6)) +
  scale_x_datetime(date_breaks = "2 hours", date_labels = "%H:%M") +
  annotate("text", x = as.POSIXct("07-28-2019 11:40:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) +
  annotate("text", x = as.POSIXct("07-28-2019 14:20:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) +
  annotate("text", x = as.POSIXct("07-28-2019 17:15:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6)  


ggsave(gswjul28_time_avg_se, filename = "figures/gswjul28_time_avg_se.pdf", device = cairo_pdf, width = 8, height = 6)
...
gswjaug1_time_avg_se<-ggplot(diurnals_2019_gsw_vs_time_aug1_avg_se, aes(interval, avg_gsw, group = treatment, color = treatment)) + 
  ...
  scale_y_continuous(breaks=seq(0,0.6,0.1), limits = c (0,0.6)) +
  scale_x_datetime(date_breaks = "2 hours", date_labels = "%H:%M") +
  annotate("text", x = as.POSIXct("08-01-2019 10:50:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) +
  annotate("text", x = as.POSIXct("08-01-2019 13:45:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) 

ggsave(gswjaug1_time_avg_se, filename = "figures/gswjaug1_time_avg_se.pdf", device = cairo_pdf, width = 8, height = 6)
...
gswjaug15_time_avg_se<-ggplot(diurnals_2019_gsw_vs_time_aug15_avg_se, aes(interval, avg_gsw, group = treatment, color = treatment)) + 
  ...
  scale_y_continuous(breaks=seq(0,0.6,0.1), limits = c (0,0.6)) +
  scale_x_datetime(date_breaks = "2 hours", date_labels = "%H:%M") +
  annotate("text", x = as.POSIXct("08-15-2019 09:15:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) +
  annotate("text", x = as.POSIXct("08-15-2019 11:25:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6)  +
  annotate("text", x = as.POSIXct("08-15-2019 13:38:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6)  +
  annotate("text", x = as.POSIXct("08-15-2019 17:15:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) 

ggsave(gswjaug15_time_avg_se, filename = "figures/gswjaug15_time_avg_se.pdf", device = cairo_pdf, width = 8, height = 6)
...
gswjaug20_time_avg_se<-ggplot(diurnals_2019_gsw_vs_time_aug20_avg_se, aes(interval, avg_gsw, group = treatment, color = treatment)) + 
  ...
  scale_y_continuous(breaks=seq(0,0.6,0.1), limits = c (0,0.6)) +
  scale_x_datetime(date_breaks = "2 hours", date_labels = "%H:%M") +
  annotate("text", x = as.POSIXct("08-20-2019 09:10:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) +
  annotate("text", x = as.POSIXct("08-20-2019 11:25:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6)  +
  annotate("text", x = as.POSIXct("08-20-2019 13:40:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6)  +
  annotate("text", x = as.POSIXct("08-20-2019 17:10:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) 

ggsave(gswjaug20_time_avg_se, filename = "figures/gswjaug20_time_avg_se.pdf", device = cairo_pdf, width = 8, height = 6)
...
gswjsep5_time_avg_se<-ggplot(diurnals_2019_gsw_vs_time_sep5_avg_se, aes(interval, avg_gsw, group = treatment, color = treatment)) + 
  ...
  scale_y_continuous(breaks=seq(0,0.6,0.1), limits = c (0,0.6)) +
  scale_x_datetime(date_breaks = "2 hours", date_labels = "%H:%M") +
  annotate("text", x = as.POSIXct("09-05-2019 09:00:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6) +
  annotate("text", x = as.POSIXct("09-05-2019 17:10:00", format="%m-%d-%Y %H:%M:%S", tz ="UTC"), y = 0.5, label = "*", size = 6)  

ggsave(gswjsep5_time_avg_se, filename = "figures/gswjsep5_time_avg_se.pdf", device = cairo_pdf, width = 8, height = 6)
...
panel_plot_gsw_time_2019_avg_se_ok <- plot_grid (gswjul25_time_avg_se, gswjul28_time_avg_se, gswjaug1_time_avg_se, gswjaug15_time_avg_se, gswjaug20_time_avg_se, gswjsep5_time_avg_se, labels=c("Pre-heatwave", "Heatwave", "Post-heatwave","Heatwave", "Post-heatwave", "Recovery", ncol=3, nrow = 2), vjust = 4.0, hjust = -1.5, label_size = 12)

ggsave(panel_plot_gsw_time_2019_avg_se_ok , filename = "figures/panel_plot_gsw_time_2019_avg_se_ok.pdf", device = cairo_pdf, width = 15, height = 8)
...
ggsave(panel_plot_gsw_time_2019_w_baseline_avg_se_ok , filename = "figures/panel_plot_gsw_time_2019_w_baseline_avg_se_ok.pdf", device = cairo_pdf, width = 15, height = 8)