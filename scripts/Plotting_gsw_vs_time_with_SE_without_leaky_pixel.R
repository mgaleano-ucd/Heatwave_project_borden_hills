...
ggsave(panel_plot_gsw_time_2019_avg_se_ok , filename = "figures/panel_plot_gsw_time_2019_avg_se_ok_without_leaky_pixel.pdf", device = cairo_pdf, width = 15, height = 8)
